...
pipeline_name="royco-rwa-markets-v2-test-pipeline"
...
prepare_and_deploy() {
    ...
    # preparation command
    mustache config/markets-v2-test/metadata.json config/markets-v2-test/pipeline.template.yaml > ${pipeline_name}.yaml
