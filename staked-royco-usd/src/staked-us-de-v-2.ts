...
export function handleAdminTransferRequested(
  event: AdminTransferRequestedEvent
): void {
  let entity = new AdminTransferRequested(
...
export function handleLockedAmountRedistributed(
  event: LockedAmountRedistributedEvent
): void {
  let entity = new LockedAmountRedistributed(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
