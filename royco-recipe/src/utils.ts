...
export const generateRawPositionId = (weirollWallet: string): string => {
  return CHAIN_ID.toString().concat("_").concat(weirollWallet);
};
...
export const generateRawPositionRecipeBoycoId = (
