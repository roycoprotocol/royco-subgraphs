 ...
 * no setter. On the deployed revision, KernelUpdated(address) reports an implementation
 * update rather than re-pointing the accountant; the latest revision removes that event.
 * The call this replaces could never have returned anything the map row doesn't already
 * say.
 *
