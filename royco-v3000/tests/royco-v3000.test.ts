...
import {
  createRoycoAccountDeployedEvent,
  createSafeSetupEvent,
  createExecutionSuccessEvent,
  createExecutionFailureEvent,
  createTransferEvent,
  createAddedOwnerEvent,
  createRemovedOwnerEvent,
  createChangedThresholdEvent,
} from "./royco-v3000-utils";
...
describe("RoycoAccountFactory tests", () => {
  beforeAll(() => {
    ...
    let roycoAccount = Address.fromString(
      "0x0000000000000000000000000000000000000002"
    );
    let newRoycoAccountDeployedEvent = createRoycoAccountDeployedEvent(
      user,
      accountId,
      roycoAccount
    );
  ...
  test("RoycoAccountDeployed created and stored", () => {
    ...
    let expectedRoycoAccountId = CHAIN_ID.toString().concat(
      "_0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd01_1"
    );
    assert.fieldEquals(
      "RoycoAccountDeployed",
    ...
    let expectedSafeId = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002"
    );
    assert.fieldEquals(
      "RawSafe",
      expectedSafeId,
...
describe("Safe template tests", () => {
  beforeAll(() => {
    ...
    let fallbackHandler = Address.fromString(
      "0x0000000000000000000000000000000000000004"
    );
    let newSafeSetupEvent = createSafeSetupEvent(
      initiator,
      owners,
      threshold,
      initializer,
  ...
  test("SafeSetup created and stored", () => {
    ...
    let expectedSafeSetupId = CHAIN_ID.toString().concat(
      "_0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd02_2"
    );
    assert.fieldEquals(
      "SafeSetup",
      expectedSafeSetupId,
    ...
    assert.fieldEquals("SafeSetup", expectedSafeSetupId, "threshold", "1");

    // Check RawSafe was updated
    let expectedSafeId2 = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002"
    );
    assert.fieldEquals("RawSafe", expectedSafeId2, "threshold", "1");

    // Check RawSafeMap was created
    let expectedSafeMapId = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002_0x0000000000000000000000000000000000000001"
    );
    assert.fieldEquals(
      "RawSafeMap",
      expectedSafeMapId,
  ...
  test("ExecutionSuccess created and stored", () => {
    let txHash =
      "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd03";
    ...
    let expectedExecutionSuccessId = CHAIN_ID.toString().concat(
      "_0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd03_3"
    );
    assert.fieldEquals(
      "ExecutionSuccess",
  ...
  test("ExecutionFailure created and stored", () => {
    let txHash =
      "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd04";
    let payment = BigInt.fromI32(0); // Set to 0 to avoid ETH tracking interference
    ...
    let expectedExecutionFailureId = CHAIN_ID.toString().concat(
      "_0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd04_4"
    );
    assert.fieldEquals(
      "ExecutionFailure",
...
describe("ERC20 token tracking tests", () => {
  ...
  test("Token transfer to Safe creates tokenized position", () => {
    ...
    let expectedTokenPositionId = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002_0x0000000000000000000000000000000000000005"
    );
    let expectedTokenId = CHAIN_ID.toString().concat(
      "-0x0000000000000000000000000000000000000005"
    );
    assert.fieldEquals(
      "RawSafeTokenizedPosition",
  ...
  test("Token transfer from Safe updates tokenized position", () => {
    ...
    let expectedTokenPositionId2 = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002_0x0000000000000000000000000000000000000005"
    );
    assert.fieldEquals(
      "RawSafeTokenizedPosition",
  ...
  test("Native ETH transfer tracking works correctly", () => {
    ...
    let expectedETHPositionId = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002_0x0000000000000000000000000000000000000000"
    );
    let expectedETHTokenId = CHAIN_ID.toString().concat(
    ...
    let expectedETHPositionId2 = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002_0x0000000000000000000000000000000000000000"
    );
    assert.fieldEquals(
      "RawSafeTokenizedPosition",
  ...
  test("ExecutionSuccess with transaction value tracks ETH transfer", () => {
    ...
    let expectedETHPositionId3 = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002_0x0000000000000000000000000000000000000000"
    );
    assert.fieldEquals(
      "RawSafeTokenizedPosition",
...
describe("Safe owner management tests", () => {
  ...
  test("Adding an owner updates Safe and creates RawSafeMap", () => {
    ...
    addedOwnerEvent.address = Address.fromString(
      "0x0000000000000000000000000000000000000002"
    );
    ...
    let expectedNewSafeMapId = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002_0x0000000000000000000000000000000000000008"
    );
    assert.fieldEquals(
      "RawSafeMap",
  ...
  test("Removing an owner updates Safe and marks RawSafeMap inactive", () => {
    let ownerToRemove = Address.fromString(
      "0x0000000000000000000000000000000000000001"
    );
    let removedOwnerEvent = createRemovedOwnerEvent(ownerToRemove);
    removedOwnerEvent.address = Address.fromString(
      "0x0000000000000000000000000000000000000002"
    );
    ...
    let expectedRemovedSafeMapId = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002_0x0000000000000000000000000000000000000001"
    );
    assert.fieldEquals(
      "RawSafeMap",
  ...
  test("Changing threshold updates Safe", () => {
    ...
    changedThresholdEvent.address = Address.fromString(
      "0x0000000000000000000000000000000000000002"
    );
    handleChangedThreshold(changedThresholdEvent);

    // Check the threshold was updated
    let expectedSafeId3 = CHAIN_ID.toString().concat(
      "_0x0000000000000000000000000000000000000002"
    );
    assert.fieldEquals("RawSafe", expectedSafeId3, "threshold", "2");
  });
});
