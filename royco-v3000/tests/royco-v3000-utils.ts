...
export function createRoycoAccountDeployedEvent(
  ...
  let roycoAccountDeployedEvent =
    changetype<RoycoAccountDeployed>(newMockEvent());
  ...
  roycoAccountDeployedEvent.parameters.push(
    new ethereum.EventParam(
      "roycoAccount",
      ethereum.Value.fromAddress(roycoAccount)
    )
  );

  // Set a unique transaction hash for testing
  roycoAccountDeployedEvent.transaction.hash = Bytes.fromHexString(
...
export function createSafeSetupEvent(
  ...
  // Set a unique transaction hash for testing
  safeSetupEvent.transaction.hash = Bytes.fromHexString(
    "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd02"
  );
...
export function createExecutionSuccessEvent(
  ...
  executionSuccessEvent.parameters.push(
    new ethereum.EventParam(
      "txHash",
      ethereum.Value.fromBytes(Bytes.fromHexString(txHash))
    )
  );
  executionSuccessEvent.parameters.push(
    new ethereum.EventParam(
  ...
  // Set a unique transaction hash for testing
  executionSuccessEvent.transaction.hash = Bytes.fromHexString(
...
export function createExecutionFailureEvent(
  ...
  // Set a unique transaction hash for testing
  executionFailureEvent.transaction.hash = Bytes.fromHexString(
...
export function createTransferEvent(
  ...
  // Set a unique transaction hash for testing
  transferEvent.transaction.hash = Bytes.fromHexString(
...
export function createAddedOwnerEvent(
  ...
  // Set a unique transaction hash for testing
  addedOwnerEvent.transaction.hash = Bytes.fromHexString(
    "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd06"
  );
...
export function createRemovedOwnerEvent(
  ...
  // Set a unique transaction hash for testing
  removedOwnerEvent.transaction.hash = Bytes.fromHexString(
    "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd07"
  );
...
export function createChangedThresholdEvent(
  ...
  // Set a unique transaction hash for testing
  changedThresholdEvent.transaction.hash = Bytes.fromHexString(
    "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd08"
  );
