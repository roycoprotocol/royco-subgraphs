 ...
 */
export function generateEventId(transactionHash: Bytes, logIndex: BigInt): string {
 ...
 */
export function generateRawSafeMapId(safeAddress: string, accountAddress: string): string {
  return CHAIN_ID.toString()
    .concat("_")
    .concat(safeAddress)
    .concat("_")
 ...
 */
export function generateRawSafeTokenizedPositionId(safeAddress: string, tokenAddress: string): string {
  return CHAIN_ID.toString()
    .concat("_")
    .concat(safeAddress)
    .concat("_")
